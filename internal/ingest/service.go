...
func New(cfg *config.Config, st *store.MarketStore) *Service {
	...
	s.ingestStatus.set("equity_yahoo", "starting")
	s.ingestStatus.set("equity_finnhub", "disabled")
	s.ingestStatus.set("equity_twelvedata", "disabled")
	s.ingestStatus.set("equity_stooq", "starting")
