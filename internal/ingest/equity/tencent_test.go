...
func TestParseTencentQuotes(t *testing.T) {
	defs := map[string]IndexDef{
		...
		"hf_SI":      {ID: "silver", Name: "国际白银", TencentSymbol: "hf_SI", MinPrice: 5, MaxPrice: 300},
		"hf_CL":      {ID: "crude", Name: "WTI原油", TencentSymbol: "hf_CL", MinPrice: 10, MaxPrice: 300},
	}
	...
	v_hf_SI="75.28,0.17,75.19,75.22,76.14,73.39,22:01:56,75.16,74.08,0,1,1,2026-05-20,纽约白银";
	v_hf_CL="102.21,-1.86,102.37,102.38,104.45,100.75,22:02:00,104.15,104.12,0,2,1,2026-05-20,纽约原油";
	`
	...
	if rows["silver"].Price != 75.28 || rows["silver"].ChangePct != 0.17 || rows["crude"].Price != 102.21 || rows["crude"].ChangePct != -1.86 {
