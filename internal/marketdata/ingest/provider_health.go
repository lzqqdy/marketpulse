...
func defaultProviderDefs(alphaEnabled bool, alphaProvider string, baiduEnabled bool) []providerDef {
	defs := []providerDef{
		...
		{Name: "eastmoney_gold", Label: "Eastmoney Gold", Category: "index", Role: "auxiliary", StaleAfter: 90 * time.Minute},
		{Name: "sina_gold", Label: "Sina Gold", Category: "index", Role: "fallback", StaleAfter: 90 * time.Minute},
